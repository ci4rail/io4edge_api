...
const file_mvbDebug_proto_rawDesc = "" +
	"\n" +
	"\x0emvbDebug.proto\x12\bmvbDebug\"\x12\n" +
	...
	"\x11generator_pattern\x18\x01 \x01(\tR\x10generatorPattern\"2\n" +
	...
	"\n" +
	"StreamData\x12*\n" +
	"\asamples\x18\x01 \x03(\v2\x10.mvbDebug.SampleR\asamplesB\rZ\vmvbDebug/v1b\x06proto3"

var (
	file_mvbDebug_proto_rawDescOnce sync.Once
	file_mvbDebug_proto_rawDescData []byte
)

func file_mvbDebug_proto_rawDescGZIP() []byte {
	file_mvbDebug_proto_rawDescOnce.Do(func() {
		file_mvbDebug_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mvbDebug_proto_rawDesc), len(file_mvbDebug_proto_rawDesc)))
	})
	return file_mvbDebug_proto_rawDescData
}

var file_mvbDebug_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_mvbDebug_proto_goTypes = []any{
...
func file_mvbDebug_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mvbDebug_proto_rawDesc), len(file_mvbDebug_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
