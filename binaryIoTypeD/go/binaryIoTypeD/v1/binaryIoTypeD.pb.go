//
//Copyright © 2024-2026 Ci4Rail GmbH <engineering@ci4rail.com>
//
...
type Sample struct {
	...
	// diagnostic information for each channel, containing the ChannelDiag bits.
	// first diag corresponds to channel 0, second to channel 1, etc.
	Diag          []uint32 `protobuf:"varint,3,rep,packed,name=diag,proto3" json:"diag,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_binaryIoTypeD_proto_rawDesc = "" +
	...
	"\x04type\"\x14\n" +
	"\x12StreamControlStart\"R\n" +
	"\x06Sample\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x06R\ttimestamp\x12\x16\n" +
	"\x06inputs\x18\x02 \x01(\aR\x06inputs\x12\x12\n" +
	"\x04diag\x18\x03 \x03(\rR\x04diag\"=\n" +
	"\n" +
	"StreamData\x12/\n" +
	"\asamples\x18\x01 \x03(\v2\x15.binaryIoTypeD.SampleR\asamples*\xa1\x01\n" +
	"\vChannelMode\x12#\n" +
...
var file_binaryIoTypeD_proto_depIdxs = []int32{
	...
	18, // 7: binaryIoTypeD.StreamData.samples:type_name -> binaryIoTypeD.Sample
