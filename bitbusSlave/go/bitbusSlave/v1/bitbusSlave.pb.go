...
func (x *FunctionControlSetResponse) GetMode() SlaveMode {
	if x != nil {
		return x.Mode
	}
...
func (x *FunctionControlSetResponse) GetHavePendingTxMsg() bool {
	if x != nil {
...
var file_bitbusSlave_proto_depIdxs = []int32{
	...
	0,  // 1: bitbusSlave.FunctionControlSetResponse.mode:type_name -> bitbusSlave.SlaveMode
