...
class TraceletMetrics(_message.Message):
    ...
    RESET_COUNT___TYPE___LOWMEMORY_FIELD_NUMBER: _ClassVar[int]
    RESET_COUNT___TYPE___WIFIFATAL_FIELD_NUMBER: _ClassVar[int]
    RESET_COUNT___TYPE___SLEEPFATAL_FIELD_NUMBER: _ClassVar[int]
