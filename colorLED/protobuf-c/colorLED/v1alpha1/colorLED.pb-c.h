...
typedef struct ColorLED__ConfigurationSet ColorLED__ConfigurationSet;
typedef struct ColorLED__ConfigurationSetResponse ColorLED__ConfigurationSetResponse;
typedef struct ColorLED__ConfigurationGet ColorLED__ConfigurationGet;
typedef struct ColorLED__ConfigurationGetResponse ColorLED__ConfigurationGetResponse;
typedef struct ColorLED__ConfigurationDescribe ColorLED__ConfigurationDescribe;
typedef struct ColorLED__RGBColor ColorLED__RGBColor;
typedef struct ColorLED__ChannelConfig ColorLED__ChannelConfig;
typedef struct ColorLED__ConfigurationDescribeResponse ColorLED__ConfigurationDescribeResponse;
typedef struct ColorLED__ConfigurationResponse ColorLED__ConfigurationResponse;
typedef struct ColorLED__FunctionControlGet ColorLED__FunctionControlGet;
typedef struct ColorLED__FunctionControlSet ColorLED__FunctionControlSet;
typedef struct ColorLED__FunctionControlGetResponse ColorLED__FunctionControlGetResponse;
typedef struct ColorLED__FunctionControlSetResponse ColorLED__FunctionControlSetResponse;
typedef struct ColorLED__StreamControlStart ColorLED__StreamControlStart;
typedef struct ColorLED__StreamData ColorLED__StreamData;
...
typedef enum _ColorLED__Color {
  ...
  COLOR_LED__COLOR__ORANGE = 7,
  COLOR_LED__COLOR__OFF = 8
 ...
 */
struct  ColorLED__ConfigurationSet
{
 ...
 */
struct  ColorLED__ConfigurationSetResponse
{
  ProtobufCMessage base;
};
 ...
 */
struct  ColorLED__ConfigurationGet
{
  ProtobufCMessage base;
};
 ...
 */
struct  ColorLED__ConfigurationGetResponse
{
  ProtobufCMessage base;
};
 ...
 */
struct  ColorLED__ConfigurationDescribe
{
  ProtobufCMessage base;
};
...
#define COLOR_LED__RGBCOLOR__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&color_led__rgbcolor__descriptor) \
    , 0, 0, 0 }
...
typedef enum {
  ...
  COLOR_LED__CONFIGURATION_RESPONSE__TYPE_DESCRIBE = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(COLOR_LED__CONFIGURATION_RESPONSE__TYPE__CASE)
 ...
 */
struct  ColorLED__ConfigurationResponse
{
  ProtobufCMessage base;
 ...
 */
struct  ColorLED__FunctionControlGet
{
  ProtobufCMessage base;
  uint32_t channel;
};
 ...
 */
struct  ColorLED__FunctionControlSet
{
  ProtobufCMessage base;
  uint32_t channel;
  protobuf_c_boolean blink;
 ...
 */
struct  ColorLED__FunctionControlSetResponse
{
  ProtobufCMessage base;
};
 ...
 */
struct  ColorLED__StreamControlStart
{
  ProtobufCMessage base;
};
...
typedef void (*ColorLED__ConfigurationDescribe_Closure)
                 (const ColorLED__ConfigurationDescribe *message,
                  void *closure_data);
typedef void (*ColorLED__RGBColor_Closure)
                 (const ColorLED__RGBColor *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor color_led__rgbcolor__descriptor;
