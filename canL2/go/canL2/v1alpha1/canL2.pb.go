...
type ConfigurationSet struct {
	...
	Sjw int32 `protobuf:"varint,3,opt,name=sjw,proto3" json:"sjw,omitempty"` // listen only mode - if activated it is not possible to send frames to the bus (and no ACK is sent by the CAN controller) -> FunctionControlSet command will fail
}
...
var file_canL2_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x4c, 0x32, 0x22, 0x5a, 0x0a, 0x10, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72,
