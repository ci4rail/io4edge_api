...
func (x *SampleGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SampleGroup) ProtoMessage() {}

func (x *SampleGroup) ProtoReflect() protoreflect.Message {
	mi := &file_analogInTypeB_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SampleGroup.ProtoReflect.Descriptor instead.
func (*SampleGroup) Descriptor() ([]byte, []int) {
	return file_analogInTypeB_proto_rawDescGZIP(), []int{13}
}

func (x *SampleGroup) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *SampleGroup) GetBaseChannel() int32 {
	if x != nil {
...
func (x *SampleGroup) GetValue() []float32 {
	if x != nil {
		return x.Value
	}
	return nil
...
type StreamData struct {
	...
	Samples []*SampleGroup `protobuf:"bytes,1,rep,name=samples,proto3" json:"samples,omitempty"`
}
...
func (x *StreamData) GetSamples() []*SampleGroup {
	if x != nil {
		return x.Samples
	}
	return nil
...
var file_analogInTypeB_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x6b, 0x22, 0x63, 0x0a, 0x0b, 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x47, 0x72, 0x6f,
	...
	,
...
var file_analogInTypeB_proto_goTypes = []interface{}{
	...
	(*SampleGroup)(nil),                   // 13: analogInTypeB.SampleGroup
...
var file_analogInTypeB_proto_depIdxs = []int32{
	...
	13, // 3: analogInTypeB.StreamData.samples:type_name -> analogInTypeB.SampleGroup
