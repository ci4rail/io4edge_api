...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=b'Z\026functionblock/v1alpha1',
...
FunctionControl = _reflection.GeneratedProtocolMessageType('FunctionControl', (_message.Message,), {
...
StreamControlStop = _reflection.GeneratedProtocolMessageType('StreamControlStop', (_message.Message,), {
...
FunctionControlResponse = _reflection.GeneratedProtocolMessageType('FunctionControlResponse', (_message.Message,), {
...
StreamControlResponse = _reflection.GeneratedProtocolMessageType('StreamControlResponse', (_message.Message,), {
