...
# source: inventory/v1alpha2/io4edge_inventory.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='inventory/v1alpha2/io4edge_inventory.proto',
  package='io4edgeInventory',
  syntax='proto3',
  serialized_options=_b('Z\022inventory/v1alpha2'),
  serialized_pb=_b('\n*inventory/v1alpha2/io4edge_inventory.proto\x12\x10io4edgeInventory\"a\n\x04Unit\x12\x14\n\x0croot_article\x18\x01 \x01(\t\x12\x15\n\rmajor_version\x18\x02 \x01(\r\x12\x0e\n\x06serial\x18\x03 \x01(\t\x12\x1c\n\x14\x63onfiguration_number\x18\x04 \x01(\rB\x14Z\x12inventory/v1alpha2b\x06proto3')
)
...
_UNIT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='configuration_number', full_name='io4edgeInventory.Unit.configuration_number', index=3,
...
Unit = _reflection.GeneratedProtocolMessageType('Unit', (_message.Message,), dict(
  DESCRIPTOR = _UNIT,
  __module__ = 'inventory.v1alpha2.io4edge_inventory_pb2'
