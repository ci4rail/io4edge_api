...
typedef struct Functionblock__Context Functionblock__Context;
typedef struct Functionblock__Command Functionblock__Command;
typedef struct Functionblock__Configuration Functionblock__Configuration;
typedef struct Functionblock__FunctionControl Functionblock__FunctionControl;
typedef struct Functionblock__StreamControlStart Functionblock__StreamControlStart;
typedef struct Functionblock__StreamControlStop Functionblock__StreamControlStop;
typedef struct Functionblock__StreamControl Functionblock__StreamControl;
typedef struct Functionblock__Error Functionblock__Error;
typedef struct Functionblock__ConfigurationResponse Functionblock__ConfigurationResponse;
typedef struct Functionblock__FunctionControlResponse Functionblock__FunctionControlResponse;
typedef struct Functionblock__StreamControlResponse Functionblock__StreamControlResponse;
typedef struct Functionblock__StreamData Functionblock__StreamData;
typedef struct Functionblock__Response Functionblock__Response;
...
typedef enum _Functionblock__Status {
  ...
  FUNCTIONBLOCK__STATUS__TEMPORARILY_UNAVAILABLE = 10
...
typedef enum {
  ...
  FUNCTIONBLOCK__COMMAND__TYPE_STREAM_CONTROL = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FUNCTIONBLOCK__COMMAND__TYPE__CASE)
} Functionblock__Command__TypeCase;

/*
 * ------- Commands ---------
 */
struct  Functionblock__Command
{
  ProtobufCMessage base;
...
typedef enum {
  ...
  FUNCTIONBLOCK__CONFIGURATION__ACTION_FUNCTION_SPECIFIC_CONFIGURATION_DESCRIBE = 30
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FUNCTIONBLOCK__CONFIGURATION__ACTION__CASE)
} Functionblock__Configuration__ActionCase;

/*
 * Configuration contains the function blocks high level configuration
 */
struct  Functionblock__Configuration
{
  ProtobufCMessage base;
...
typedef enum {
  ...
  FUNCTIONBLOCK__FUNCTION_CONTROL__ACTION_FUNCTION_SPECIFIC_FUNCTION_CONTROL_GET = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FUNCTIONBLOCK__FUNCTION_CONTROL__ACTION__CASE)
 ...
 */
struct  Functionblock__FunctionControl
{
  ProtobufCMessage base;
 ...
 */
struct  Functionblock__StreamControlStart
{
  ProtobufCMessage base;
  /*
 ...
 */
struct  Functionblock__StreamControlStop
{
  ProtobufCMessage base;
};
...
typedef enum {
  ...
  FUNCTIONBLOCK__STREAM_CONTROL__ACTION_STOP = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FUNCTIONBLOCK__STREAM_CONTROL__ACTION__CASE)
} Functionblock__StreamControl__ActionCase;

/*
 * StreamControl specifies if the stream shall be started or stopped
 */
struct  Functionblock__StreamControl
{
  ProtobufCMessage base;
...
typedef enum {
  ...
  FUNCTIONBLOCK__CONFIGURATION_RESPONSE__ACTION_FUNCTION_SPECIFIC_CONFIGURATION_DESCRIBE = 30
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FUNCTIONBLOCK__CONFIGURATION_RESPONSE__ACTION__CASE)
} Functionblock__ConfigurationResponse__ActionCase;

struct  Functionblock__ConfigurationResponse
{
  ProtobufCMessage base;
...
typedef enum {
  ...
  FUNCTIONBLOCK__FUNCTION_CONTROL_RESPONSE__ACTION_FUNCTION_SPECIFIC_FUNCTION_CONTROL_GET = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FUNCTIONBLOCK__FUNCTION_CONTROL_RESPONSE__ACTION__CASE)
} Functionblock__FunctionControlResponse__ActionCase;

struct  Functionblock__FunctionControlResponse
{
  ProtobufCMessage base;
...
struct  Functionblock__StreamControlResponse
{
  ProtobufCMessage base;
};
...
struct  Functionblock__StreamData
{
  ProtobufCMessage base;
  /*
...
typedef enum {
  ...
  FUNCTIONBLOCK__RESPONSE__TYPE_STREAM = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FUNCTIONBLOCK__RESPONSE__TYPE__CASE)
} Functionblock__Response__TypeCase;

struct  Functionblock__Response
{
  ProtobufCMessage base;
  Functionblock__Context *context;
