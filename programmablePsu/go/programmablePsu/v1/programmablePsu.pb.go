...
func (x *CalibrationValues) GetCalibrationDate() *timestamppb.Timestamp {
	if x != nil {
...
const file_programmablePsu_proto_rawDesc = "" +
	...
	"\fcurrent_gain\x18\x05 \x01(\x01R\vcurrentGain\"\x93\x01\n" +
...
var file_programmablePsu_proto_depIdxs = []int32{
	21, // 0: programmablePsu.CalibrationValues.calibration_date:type_name -> google.protobuf.Timestamp
	2,  // 1: programmablePsu.ConfigurationSet.calibrationValues:type_name -> programmablePsu.CalibrationValues
	2,  // 2: programmablePsu.ConfigurationGetResponse.calibration_values:type_name -> programmablePsu.CalibrationValues
	9,  // 3: programmablePsu.FunctionControlSet.setDefaults:type_name -> programmablePsu.SetDefaults
	10, // 4: programmablePsu.FunctionControlSet.setVoltageLevel:type_name -> programmablePsu.SetVoltageLevel
	11, // 5: programmablePsu.FunctionControlSet.setOutputEnabled:type_name -> programmablePsu.SetOutputEnabled
	12, // 6: programmablePsu.FunctionControlSet.setCurrentLimit:type_name -> programmablePsu.SetCurrentLimit
	13, // 7: programmablePsu.FunctionControlSet.recover:type_name -> programmablePsu.Recover
