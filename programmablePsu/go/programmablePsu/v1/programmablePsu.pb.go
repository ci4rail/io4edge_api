...
type ConfigurationSet_CalibrationValues struct {
	...
	CalibrationValues *CalibrationValues `protobuf:"bytes,1,opt,name=calibration_values,json=calibrationValues,proto3,oneof"`
}
...
var file_programmablePsu_proto_depIdxs = []int32{
	...
	2,  // 1: programmablePsu.ConfigurationSet.calibration_values:type_name -> programmablePsu.CalibrationValues
