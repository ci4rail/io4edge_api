...
typedef struct MvbSniffer__Telegram MvbSniffer__Telegram;
typedef struct MvbSniffer__TelegramCollection MvbSniffer__TelegramCollection;
...
struct  MvbSniffer__TelegramCollection
{
  ProtobufCMessage base;
  size_t n_entry;
