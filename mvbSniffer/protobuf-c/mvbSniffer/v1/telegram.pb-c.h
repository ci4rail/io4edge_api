...
typedef enum _MvbSniffer__TelegramCollection__Line {
  MVB_SNIFFER__TELEGRAM_COLLECTION__LINE__kA = 0,
  MVB_SNIFFER__TELEGRAM_COLLECTION__LINE__kB = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MVB_SNIFFER__TELEGRAM_COLLECTION__LINE)
...
struct  _MvbSniffer__Telegram
{
  ...
  MvbSniffer__Timestamp *timestamp;
...
#define MVB_SNIFFER__TELEGRAM__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&mvb_sniffer__telegram__descriptor) \
    , NULL, MVB_SNIFFER__TELEGRAM__STATE__kSuccessful, MVB_SNIFFER__TELEGRAM__TYPE__kProcessData16Bit, 0, {0,NULL}, 0 }
...
extern const ProtobufCEnumDescriptor    mvb_sniffer__telegram_collection__line__descriptor;
